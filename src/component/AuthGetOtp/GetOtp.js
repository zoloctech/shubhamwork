                    ...
                    <div className="col-lg-5 col-md-5 col-12">
                      <div className="bg-white rounded10 shadow-lg">
                        <div className="content-top-agile p-20 pb-0">
                          <h2 className="text-primary">Get Otp By Phone</h2>
                        ...
                        <div className="p-40">
                          <Form key="oneForm">
                            ...
                            {/* {errors.phone_or_email && touched.phone_or_email ? (
                          ...
                          {/* <div className="text-center">
									<p className="mt-15 mb-0">Already have an account?<a href="auth_login.html" className="text-danger ms-5"> Sign In</a></p>
								</div> */}
                        </div>
                      </div>
